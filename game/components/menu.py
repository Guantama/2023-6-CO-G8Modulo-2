...
class Menu:
    ...
    def __init__(self, message, screen):
        ...
        self.text = self.font.render(message, True, (255,255,0))
    ...
    def show_scores(self, score, highscore, deaths):
        self.score = self.font.render(" Your score:  " + score, True, (255,255,0))
        self.text_rect2 = self.score.get_rect()
        self.text_rect2.center = (self.HALF_SCREEN_WIDTH , self.HALF_SCREEN_HEIGHT - 40)

        self.highscore = self.font.render("Highest score: " + highscore, True, (255,255,0))
        self.text_rect3 = self.highscore.get_rect()
        self.text_rect3.center = (self.HALF_SCREEN_WIDTH, self.HALF_SCREEN_HEIGHT + 20)

        self.deaths = self.font.render("  Deaths:  " + deaths, True, (255,255,0))
        self.text_rect4 = self.score.get_rect()
        self.text_rect4.center = (self.HALF_SCREEN_WIDTH, self.HALF_SCREEN_HEIGHT + 80)